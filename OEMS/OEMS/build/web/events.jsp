...
<section class="services">
    ...
    <h3>
        <a href="photography.jsp" style="text-decoration:none; color:inherit;">
            Photography
        </a>
    </h3>
    ...
    <h3><a href="catering.jsp" style="text-decoration:none; color:inherit;">Catering</a></h3>
...
<div class="service-card">
    ...
    <h3><a href="decoration.jsp" style="text-decoration:none; color:inherit;">Decoration</a></h3>
...
<div class="service-card">
    ...
    <h3><a href="venue.jsp" style="text-decoration:none; color:inherit;">Venue</a></h3>
...
<div class="service-card">
    ...
    <h3><a href="styling.jsp" style="text-decoration:none; color:inherit;">Styling</a></h3>
