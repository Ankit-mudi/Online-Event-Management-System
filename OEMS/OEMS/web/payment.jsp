        ...
        <div class="payment-method">
            <label class="method card">
                <div class="card-logos">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Visa_Inc._logo.svg" alt="Visa Logo" width="60"/>
                </div>
                <div class="radio-input">
                    <input type="radio" name="payment" checked /> Pay ₹<%= totalPrice %> with Visa
                </div>
            </label>
            <label class="method rupay">
                <img src="https://upload.wikimedia.org/wikipedia/commons/c/cb/Rupay-Logo.png" alt="Rupay Logo" width="60"/>
                <div class="radio-input">
