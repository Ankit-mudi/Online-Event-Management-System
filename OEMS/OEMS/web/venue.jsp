...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    /* Hero Banner */
    .hero { background: url('https://d12m9erqbesehq.cloudfront.net/wp-content/uploads/sites/2/2023/11/12193749/Types-of-social-events-wedding-celebrations.jpg') no-repeat center center/cover; height:60vh; display:flex; align-items:center; justify-content:center; flex-direction:column; text-align:center; color:#fff; padding:20px; }
    ...
    .venue-card { background:white; padding:25px; border-radius:12px; text-align:center; box-shadow:0 4px 10px rgba(0,0,0,0.1); transition:0.3s; }
...
<body>
  ...
  <section class="venues-section" id="venues">
    ...
    <div class="venue-grid">
      ...
      <!-- Night Palace -->
      <div class="venue-card">
        <img src="https://plus.unsplash.com/premium_photo-1664530452529-60020787050a?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0" alt="Night Palace">
        <h3>Night Palace</h3>
        <p>Raniganj</p>
        <div class="price">71,000</div>
        <form action="VenueServlet" method="post">
          <input type="hidden" name="vname" value="Night Palace">
          <input type="hidden" name="vprice" value="71000">
          <button type="submit" class="btn">Book Now</button>
        </form>
      </div>
      ...
      <!-- Raj Darbar -->
      <div class="venue-card">
        <img src="https://images.unsplash.com/photo-1631700916136-559cb6e4de27?q=80&w=687&auto=format&fit=crop" alt="Raj Darbar">
        <h3>Raj Darbar</h3>
        <p>Durgapur</p>
        <div class="price">1,17,000</div>
        <form action="VenueServlet" method="post">
          <input type="hidden" name="vname" value="Raj Darbar">
          <input type="hidden" name="vprice" value="117000">
          <button type="submit" class="btn">Book Now</button>
        </form>
      </div>
      ...
      <!-- The Maharajas -->
      <div class="venue-card">
        <img src="https://images.unsplash.com/photo-1675247488725-22d1b78e75db?q=80&w=1170&auto=format&fit=crop" alt="The Maharajas">
        <h3>The Maharajas</h3>
        <p>Kolkata</p>
        <div class="price">1,51,000</div>
        <form action="VenueServlet" method="post">
          <input type="hidden" name="vname" value="The Maharajas">
          <input type="hidden" name="vprice" value="151000">
          <button type="submit" class="btn">Book Now</button>
        </form>
      </div>
      ...
      <!-- Royal Garden -->
      <div class="venue-card">
        <img src="https://images.unsplash.com/photo-1568530873454-e4103a0b3c71?q=80&w=1170&auto=format&fit=crop" alt="Royal Garden">
        <h3>Royal Garden</h3>
        <p>Barddhaman</p>
        <div class="price">57,600</div>
        <form action="VenueServlet" method="post">
          <input type="hidden" name="vname" value="Royal Garden">
          <input type="hidden" name="vprice" value="57600">
          <button type="submit" class="btn">Book Now</button>
        </form>
      </div>
